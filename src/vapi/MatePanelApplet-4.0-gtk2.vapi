...
namespace MatePanel {
	...
	public class Applet : Gtk.EventBox, Atk.Implementor, Gtk.Buildable {
		...
		public MatePanel.AppletBackgroundType get_background (Gdk.Color color, Gdk.Pixmap pixmap);
		...
		public virtual signal void change_background (MatePanel.AppletBackgroundType type, Gdk.Color color, Gdk.Pixmap pixmap);
