/* MatePanelApplet-4.0.vapi generated by vapigen-0.34, do not modify. */
...
namespace MatePanel {
	...
	public class Applet : Gtk.EventBox, Atk.Implementor, Gtk.Buildable {
		...
		public MatePanel.AppletBackgroundType get_background (Gdk.RGBA color, Cairo.Pattern pattern);
		...
		public virtual signal void change_background (MatePanel.AppletBackgroundType type, Gdk.RGBA color, Cairo.Pattern pattern);
	...
	[CCode (cheader_filename = "mate-panel-applet.h", cprefix = "PANEL_", type_id = "mate_panel_applet_background_type_get_type ()")]
	public enum AppletBackgroundType {
		NO_BACKGROUND,
		COLOR_BACKGROUND,
		PIXMAP_BACKGROUND
	}
	[CCode (cheader_filename = "mate-panel-applet.h", cprefix = "MATE_PANEL_APPLET_", type_id = "mate_panel_applet_flags_get_type ()")]
	[Flags]
	...
	[CCode (cheader_filename = "mate-panel-applet.h", cprefix = "MATE_PANEL_APPLET_ORIENT_", type_id = "mate_panel_applet_orient_get_type ()")]
